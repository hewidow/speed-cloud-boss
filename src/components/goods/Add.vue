...
<!--      &lt;!&ndash; 注意一下嵌套规则, 表格form嵌套tabs&ndash;&gt;-->
...
<!--            &lt;!&ndash; 在Form组件中, 每个表单域由一个Form-Item组件构成, 表单域中可以放置各种类型的表单控件,-->
...
<!--              &lt;!&ndash;  选择商品分类区域 &ndash;&gt;-->
<!--              <el-row>-->
<!--                <el-col>-->
<!--                  &lt;!&ndash; 选择商品分类的级联选择框 &ndash;&gt;-->
<!--                  <el-cascader-->
